#!/bin/bash
#
# Process SFT Datasets Pipeline - Complete 4-Step Processing
#
# Task:
# 1. Extract 24000 samples from train (GT >= 2)
# 2. Extract 1000 samples from test
# 3. Extract 1000 samples from validation
#
# Each dataset goes through 4 steps:
#   Step 1: filter_sft_samples.py
#   Step 2: assign_traits_via_gpt.py
#   Step 3: filter_violating_groundtruth.py
#   Step 4: analyze_trait_distribution.py
#
# Usage:
#   bash scripts/phase0_trait_assignment/process_sft_datasets.sh [--test]
#
...
echo "=========================================="
echo "SFT Datasets Pipeline"
echo "=========================================="
echo ""

# Paths
SFT_BASE="downloaded_datasets/processed_datasets/sft_dataset"
...
# ========================================
# Process Dataset 2: Test (1000, no GT filter)
# ========================================
process_dataset \
    "$SFT_BASE/test" \
    "test" \
    ...
    "sft_test_1k"
# ========================================
# Process Dataset 3: Validation (1000, no GT filter)
# ========================================
process_dataset \
    "$SFT_BASE/validation" \
    "validation" \
...
# ========================================
# Process Dataset 1: Train (24000, GT >= 2)
# ========================================
process_dataset \
    "$SFT_BASE/train" \
    "train" \
...
echo ""
echo "=========================================="
echo "SFT Datasets Pipeline Complete!"
echo "=========================================="
echo ""
echo "Output files in $OUTPUT_DIR:"
echo ""
echo "SFT Train (24k):"
echo "  - Filtered: ${OUTPUT_DIR}/sft_train_24k_filtered.json"
echo "  - With traits: ${OUTPUT_DIR}/sft_train_24k_with_traits.json"
echo "  - Final: ${OUTPUT_DIR}/sft_train_24k_final.json"
echo "  - Stats: ${OUTPUT_DIR}/sft_train_24k_stats/"
echo ""
echo "SFT Test (1k):"
echo "  - Filtered: ${OUTPUT_DIR}/sft_test_1k_filtered.json"
echo "  - With traits: ${OUTPUT_DIR}/sft_test_1k_with_traits.json"
echo "  - Final: ${OUTPUT_DIR}/sft_test_1k_final.json"
echo "  - Stats: ${OUTPUT_DIR}/sft_test_1k_stats/"
echo ""
echo "SFT Validation (1k):"
echo "  - Filtered: ${OUTPUT_DIR}/sft_val_1k_filtered.json"
echo "  - With traits: ${OUTPUT_DIR}/sft_val_1k_with_traits.json"
echo "  - Final: ${OUTPUT_DIR}/sft_val_1k_final.json"
echo "  - Stats: ${OUTPUT_DIR}/sft_val_1k_stats/"
echo ""
echo "Next steps:"
echo "  1. Review trait distributions in *_stats/ directories"
echo "  2. Run process_grpo_dataset.sh to process GRPO data"
echo ""
